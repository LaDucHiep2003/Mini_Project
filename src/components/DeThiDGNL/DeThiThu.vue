...
<template>
    <div class="text-center">
        <div class="text-3xl font-semibold text-color-3 mb-2">Đề thi thử đánh giá năng lực</div>
        <div class="text-color-4 text-base">Tổng hợp mẫu các dạng đề thi đánh giá năng lực của các trường với ngân hàng câu hỏi và 
        ...
        <div class="grid grid-cols-4 justify-center items-center">
            <RouterLink to="/de-thi-dgnl/de-thi-dgnl-dhqg-ha-noi" class="shadow-shadow-1 cart-dgnl p-4 rounded-2xl transition-all duration-300 w-[270px] h-[320px] mt-8 mb-auto mx-auto mr-0 hover:translate-y-[-16px] hover:shadow-shadow-2">
                <div>
                    ...
                    <div class="mt-5">
                        <div class="text-xl font-semibold text-title transition-all duration-300">ĐHQG Hà Nội</div>
                        <div class="text-color-4 text-base mt-3">Luyện đề thi thử ĐGNL Đại học quốc gia Hà Nội có đáp án mới nhất </div>
                    </div>
                </div>
            </RouterLink>
